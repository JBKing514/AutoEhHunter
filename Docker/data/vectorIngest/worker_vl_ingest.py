...
def main(argv: list[str]) -> int:
    ...
    ap.add_argument("--vl-base", default=os.getenv("VL_BASE", ""), help="VLM server base URL")
    ap.add_argument("--emb-base", default=os.getenv("EMB_BASE", ""), help="Embedding server base URL")
